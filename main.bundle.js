...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__gallery_service__ = __webpack_require__("./src/app/gallery.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_14__gallery_service__["a" /* GalleryService */]
                /* . . . */
            ],
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.fillHeroes = function () {
        var _this = this;
...
var GalleryService = /** @class */ (function () {
    ...
    GalleryService.prototype.search = function (keyWord, size, page) {
        console.log(keyWord);
        return this.http.get("https://pixabay.com/api/?key=8971756-3eff7aa4fde1f3b1f60ad4220&q="
...
module.exports = "<p></p>\n<div class=\"container\">\n  <div class=\"card card-primary\">\n    <div class=\"card-header\">Gallery component</div> \n    <div class=\"card-block\">\n      <form #galleryform=\"ngForm\" (ngSubmit)=\"onSearch(galleryform.value)\">\n        <div class=\"form-group\">\n          <label>keyword:</label> \n          <input type=\"text\" name=\"keyWord\" ngModel required [(ngModel)]=\"motCle\">\n          <button type=\"submit\" class=\"btn btn-primary\">Chercher</button>\n        </div>\n      </form>\n      \n      <div class=\"row\" >\n        <div *ngFor=\"let img of pagePhotos?.hits\" class=\"col-md-4\">\n          <div class=\"card card-primary cadre\"  >\n            <div class=\"card-header\">{{motCle}}</div>\n            <div class=\"card-block\">\n              <p>User : {{img.user}}</p>  \n              <img src=\"{{img.previewURL}}\">\n            </div>\n          </div>\n        </div>\n      </div>\n\n      <div class=\"row\">\n        <ul class=\"nav nav-pills\" >\n          <li  class=\"nav-item clickable\" *ngFor=\"let page of pages; let i=index;\" >\n            <a [ngClass]=\"{'active':currentPage==i+1}\" (click)=\"goToPage(i)\" class=\"nav-link\" >{{i}}</a>\n          </li>\n        </ul>\n      </div>\n\n\n    </div>\n  </div>\n</div>\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__gallery_service__ = __webpack_require__("./src/app/gallery.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var GalleryComponent = /** @class */ (function () {
    ...
    GalleryComponent.prototype.onSearch = function (dataForm) {
        ...
        this.galleryService.search(dataForm.keyWord, this.size, this.currentPage).subscribe(function (data) {
            //console.log(JSON.stringify(data));  
            _this.pagePhotos = data;
            _this.totalPages = data['totalHits'] / _this.size;
            console.log(_this.totalPages);
            if (_this.totalPages % 2 != 0)
    ...
    GalleryComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__gallery_service__["a" /* GalleryService */]])
    ], GalleryComponent);
...
var HeroService = /** @class */ (function () {
   ...
   */
    ...
    HeroService.prototype.updateHero = function (hero) {
        var _this = this;
        return this.http.put(this.heroesUrl, hero, httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["e" /* tap */])(function (_) { return _this.log("updated hero id=" + hero.id); }), Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["a" /* catchError */])(this.handleError('updateHero')));
    };
    /** POST: add a new hero to the server */
    HeroService.prototype.addHero = function (hero) {
        var _this = this;
        return this.http.post(this.heroesUrl, hero, httpOptions).pipe(Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["e" /* tap */])(function (hero) { return _this.log("added hero w/ id=" + hero.id); }), Object(__WEBPACK_IMPORTED_MODULE_4_rxjs_operators__["a" /* catchError */])(this.handleError('addHero')));
    };
    ...
    HeroService = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["A" /* Injectable */])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__angular_common_http__["a" /* HttpClient */], __WEBPACK_IMPORTED_MODULE_2__message_service__["a" /* MessageService */]])
    ], HeroService);
    return HeroService;
}());
...
var HeroesComponent = /** @class */ (function () {
    ...
    HeroesComponent.prototype.fillHeroes = function () {
        var _this = this;
        this.heroService.getHeroes()
...
module.exports = "<div class=\"form-group\" *ngIf=\"messageService.messages.length\">\n\n  <h2>Messages</h2>\n  <button class=\"clear\"\n          (click)=\"messageService.clear()\">clear</button>\n  <div *ngFor='let message of messageService.messages'> {{message}} </div>\n\n</div>\n"
